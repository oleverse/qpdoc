...
from app.routes import auth, profile, upload_pdf, llm_endpoint, history, user_files
...
app.include_router(llm_endpoint.router, prefix='/api')
app.include_router(history.router, prefix='/api')
app.include_router(user_files.router, prefix='/api')
